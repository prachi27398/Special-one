...
export default function App() {
  ...
  const content = useMemo(
    () => ({
      ...
      photos: [
        `${import.meta.env.BASE_URL}photos/love.jpeg`,
        `${import.meta.env.BASE_URL}photos/2.jpeg`,
        // "/photos/3.jpeg",
        `${import.meta.env.BASE_URL}photos/4.jpeg`,
        `${import.meta.env.BASE_URL}photos/5.jpeg`,
        // "/photos/6.jpeg",
      ],
